...
package ca.ubc.cs.beta.paramils.misc.version;
...
public class ParamILSVersionInfo extends AbstractVersionInfo {
  public ParamILSVersionInfo() {
    super("ParamILS", "paramils-version.txt", true);
  }
}
