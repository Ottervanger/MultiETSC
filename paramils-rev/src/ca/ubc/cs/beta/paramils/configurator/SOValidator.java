...
public class SOValidator extends SOBasicILS {

  public ParameterConfiguration incumbent = null;
  public double incumbentCost;

  /* ======================================================================
   * Constructor
   * ====================================================================== */

  public SOValidator(ParamILSOptions paramilsOptions,
  ...
  public void doValidation() {
    ...
    incumbentCost = computeConfigCost(incumbent, n);
  }
  ...
  public void logValidationMessage() {
    log.info("Estimated {} on test set: {}", objectiveToReport, formatCost(incumbentCost));
