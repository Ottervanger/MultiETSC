...
public class ParamILSRuntimeException extends RuntimeException {

  private static final long serialVersionUID = 6012822616367601464L;

  public ParamILSRuntimeException(String message) {
    super(message);
  }
  public ParamILSRuntimeException(Throwable t) {
    super(t);
  }
