...
int main ()
{
    //double (*training)[DIMENSION] = new double[ROWTRAINING][DIMENSION];
	// load training data
    ...
    // load testing data
	//LoadData(testingFileName, testing,labelTesting);
...
void BuildIndex()
{
	...
	//double  CurrentMinDis[ROWTRAINING][DIMENSION]={0};// 
    //double (*CurrentMinDis)[DIMENSION] = new double[ROWTRAINING][DIMENSION];
    clock_t t3, t4;
