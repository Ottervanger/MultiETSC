function [ maximum ] = QDA_max_f_problem( sigma, x_k, m_u, R_inv , mu_k, mu_u, delta )
...
%The minorization iteration stops when the change in the maximum is less 
%than the threshold, making this smaller gives a more accurate solution, 
